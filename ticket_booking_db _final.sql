...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2024 at 08:43 AM
...
(1, 'Admin08', '0ecf0285c52337d198723ffcb06c19313d1790be40acb6c6887e1810e5ada879'),
(2, '8admin', 'ca3eb21aa955a042d93a9bd81eceab347656d74f95009b7307fe9299c795c7dd'),
...
(50, 'shiv bb', '9999990000', 'bb@gmail.com', '2015-08-13', 1, 27);
...
(11, 7, 7, '2023-08-11 10:53:00', '2025-08-11 08:15:00', 134.00),
(12, 11, 11, '2024-08-29 13:00:00', '2024-08-29 14:00:00', 800.00),
(13, 10, 10, '2024-08-29 14:52:20', '2024-08-29 14:52:50', 400.00),
(14, 9, 9, '2024-08-30 13:00:23', '2024-08-31 08:15:12', 890.00);

-- --------------------------------------------------------

--
-- Table structure for table `tripseat_14`
--

CREATE TABLE `tripseat_14` (
  `SeatNumber` int(11) NOT NULL,
  `TicketID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tripseat_14`
--

INSERT INTO `tripseat_14` (`SeatNumber`, `TicketID`) VALUES
(1, NULL),
(2, NULL),
(3, NULL),
(4, NULL),
...
--
-- Indexes for table `tripseat_14`
--
ALTER TABLE `tripseat_14`
...
--
ALTER TABLE `passenger`
  MODIFY `PassengerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
-- Constraints for table `tripseat_14`
--
ALTER TABLE `tripseat_14`
  ADD CONSTRAINT `tripseat_14_ibfk_1` FOREIGN KEY (`TicketID`) REFERENCES `ticket` (`TicketID`);
COMMIT;
